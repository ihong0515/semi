...
hotel_phone varchar2(50),
hotel_addr varchar2(50) not null,
hotel_location varchar2(50) not null,
hotel_email varchar2(50),
hotel_info varchar2(1000),
hotel_room_count number(20),
hotel_establish number(20),
hotel_photo_folder varchar2(50),
...
hp_hotelno number(10) references hotel(hotel_no),
...
room_hotelno number(10) references hotel(hotel_no),
...
reserv_hotelno number(10) references hotel(hotel_no),
reserv_hotelname varchar2(100),
reserv_roomno number(10) references room(room_no),
reserv_roomname varchar2(100),
reserv_userno number(10) references user1(user_no),
...
create table owner(
    ...
    owner_hotelno number(10) not null references hotel(hotel_no),
