...
<li>또한 서비스의 중요 안내사항 및 예약에 대한 정보는 마케팅 정보 수신 동의 여부와 관계없이 발송됩니다.</li>
...
<li>2. 수집·이용항목</li>
<li>- 회원 정보(스테이폴리오 아이디, 이름, 휴대폰 번호, 이메일, 가입일시)</li>
<li>- 예약 서비스 정보(이용 숙소, 인원 정보, 이용 횟수)</li>
<li>- 수집∙이용항목은 마케팅 및 분석, 프로모션의 목적에 따라 달라질 수 있음</li>

<li>3. 보유 및 이용기간</li>
<li>- 정보 삭제 또는 이용 정지 요청 및 회원탈퇴 시 즉시 삭제</li>

<li>4. 마케팅 활용 정보 수집 방법</li>
<li>- 희망자에 한해 직접 입력</li>
</ul>
</body>
</html>