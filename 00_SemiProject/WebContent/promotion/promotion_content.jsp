...
<body>
	...
	<div id = "promotion_content_container">		
		...
		<div id = "promtion_content_footer">
			...
			<b>예약 규정</b>
			<br> 
			프로모션 기간: 2023년 6월 30일까지. 플랫폼: 트립닷컴 앱, 웹사이트, 모바일 웹사이트. 원
			플러스 원(1+1) 프로모션: 3.1. 프로모션 기간 동안 트립닷컴 플랫폼에서 에어 마카오가 운항하는 1+1 혜택이
			적용된 마카오행 직항 왕복 항공권 특가를 제공합니다. 2인 예매 시 1+1 혜택이 제공됩니다. (여행 날짜는 반드시
			2023년 9월 30일 이전이어야 함) (※ 안내: 프로모션 페이지에 표시된 가격은 1+1 혜택이 적용된 1인 왕복
			항공권 특가) 3.2. 항공편 가는편과 오는편 사이에는 반드시 2~7일 기간이 있어야 합니다. 3.3. 대상 탑승객
			유형: 좌석이 필요한 성인, 어린이, 유아. 상기 가격은 실제 할인이 적용된 가격으로 상황에 따라 변경될 수 있습니다.
