	...
	await $.ajax({
		...
		success : function(data){
			...
			$(data).find("hotel").each(function(){
					...
					table += "<div class='index_hotel_content'>";
					...
					table += "<div class='hotel_review'>";
					table += $(this).find("hotel_point").text() + "/10";
					table += "<span class='hotel_review_count'>";
					table += "&nbsp;&nbsp;리뷰 "+$(this).find("review_count").text()+"개";
					table += "</span>";
					table += "</div>";
