...
function id_check(i){
	...
	if(i==1){
		if($(name).val()==''){
			...
			$('#id_form').attr('action',
			 contextPath+'/user_id_search.do?check=id_search');
			$('#id_form').submit();
		}
	}else if(i==2){
		if($(name).val()==''){
			...
			$('#id_form').attr('action',
			 contextPath+'/user_Email_Check.do?check=id_search');
			$('#id_form').submit();
		}
	}
}
	...
	if(i==1){
		if($(id).val()==''){
			...
			$('#pwd_form').attr('action',
			 contextPath+'/user_pwd_search.do?check=pwd_search');
			$('#pwd_form').submit();
		}
	}else if(i==2){
		if($(id).val()==''){
			...
			$('#pwd_form').attr('action',
			 contextPath+'/user_Email_Check.do?check=pwd_search');
			$('#pwd_form').submit();
		}
	}else if(i==3){
		if($(id).val()==''){
