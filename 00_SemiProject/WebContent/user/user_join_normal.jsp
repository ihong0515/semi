...
5. 동의 거부권 등에 대한 고지: 정보주체는 개인정보 제공 동의를 거부할 권리가 있으나, 이 경우 상품 및 서비스 예약이 제한될 수 있습니다.
					...
					<div id="detail" style="display:none;overflow:scroll;text-align:left;width:400px;height:200px;">
					 	<pre>
제 1조 (총칙)
1. 개인정보란 생존하는 개인에 관한 정보로서 당해 정보에 포함되어 있는 성명, 주민등록번호 등의 사항에 의하여 당해 개인을 식별할 수 있는 정보
(당해 정보만으로는 특정 개인을 식별할 수 없더라도 다른 정보와 용이하게 결합하여 식별할 수 있는 것을 포함합니다.) 를 말합니다.
2. 스테이폴리오는 귀하의 개인정보 보호를 매우 중요시하며, ‘정보통신망 이용촉진 및 정보보호에 관한 법률’ 상의 개인정보 보호규정 및 정보통신부가 제정한 ‘개인정보 보호지침’을 준수하고 있습니다.
3. 스테이폴리오는 개인정보처리방침을 정하고 이를 귀하께서 언제나 쉽게 확인할 수 있게 공개하도록 하고 있습니다.
4. 스테이폴리오는 개인정보 처리방침의 지속적인 개선을 위하여 개정하는데 필요한 절차를 정하고 있으며, 개인정보 처리방침을 회사의 필요한 사회적 변화에 맞게 변경할 수 있습니다.
그리고 개인정보처리방침을 개정하는 경우 버전번호 등을 부여하여 개정된 사항을 귀하께서 쉽게 알아볼 수 있도록 하고 있습니다.

제 2조 (수집하는 개인정보 항목 및 수집방법)
1. 스테이폴리오는 별도의 회원가입 절차 없이 대부분의 컨텐츠에 자유롭게 접근할 수 있습니다. 스테이폴리오에서 예약 및 프로모션. 이벤트 서비스를 이용하시고자 할 경우 다음의 정보를 입력해주셔야 합니다.- 입력항목 : 희망ID, 비밀번호, 성명, 이메일주소
2. 또한 서비스 이용과정이나 사업 처리 과정에서 아래와 같은 정보들이 생성되어 수집될 수 있습니다.- 최근접속일, 접속 IP 정보, 쿠키, 구매로그, 이벤트로그
...
3. 스테이폴리오는 다음과 같은 방법으로 개인정보를 수집합니다.- 홈페이지, 서면양식, 팩스, 전화, 상담 게시판, 이메일, 이벤트 응모, 예약신청
- 로그 분석 프로그램을 통한 생성정보 수집
4. 개인정보 수집에 대한 동의
- 스테이폴리오는 귀하께서 스테이폴리오의 개인정보처리방침 및 이용약관의 내용에 대해 「동의한다」버튼 또는 「동의하지 않는다」버튼을 클릭할 수 있는 절차를 마련하여, 「동의한다」버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다.
5. 14세 미만 아동의 개인정보보호
- 스테이폴리오는 법정 대리인의 동의가 필요한 만14세 미만 아동의 회원가입은 받고 있지 않습니다.
6. 비회원의 개인정보보호
- 스테이폴리오는 비회원 주문의 경우에도 예약정보, 대금결제, 예약내역 조회 및 예약확인, 실명여부 확인을 위하여 필요한 개인정보만을 요청하고 있으며,
이 경우 그 정보는 대금결제 및 객실예약 관련된 용도 이외에는 다른 어떠한 용도로도 사용되지 않습니다.
- 스테이폴리오는 비회원의 개인정보도 회원과 동등한 수준으로 보호합니다.

제 3조 (개인정보의 수집목적 및 이용 목적)
- 스테이폴리오는 다음과 같은 목적을 위하여 개인정보를 수집하고 있습니다.
...
제 4조 (개인정보의 공유 및 제공)
- 스테이폴리오는 회원에 대하여 보다 더 질 높은 서비스 제공 등을 위해 아래와 같이 귀하의 개인정보를 제공하고 있습니다.
1. 제공정보의 이용 목적 : 제휴 마케팅, 예약 고객의 응대 및 서비스 제공 제공 정보의
...
3. 이용자들이 사전에 동의한 경우
4. 그러나 예외사항에서도 관계법령에 의하거나 수사기관의 요청에 의해 정보를 제공한 경우에는 이를 당사자에게 고지하는 것을 원칙으로 운영하고 있습니다.
법률상의 근거에 의해 부득이하게 고지를 하지 못할 수도 있습니다. 본래의 수집목적 및 이용목적에 반하여 무분별하게 정보가 제공되지 않도록 최대한 노력하겠습니다.

제 5조 (수집한 개인정보 취급 위탁)
1. (주)비바퍼블리카, 네이버 파이낸셜 : 상품 구매에 필요한 신용카드, 현금결제 등의 결제정보 전송
2. 케이티하이텔주식회사 : SMS, MMS등 문자메세지 전송
3. 다이렉트샌드: 알림톡 발송
4. 스티비: 이메일 전송
5. Amazon Web Service Inc: 인프라 제공
6. [예약상품판매 제휴업체](https://www.notion.so/9b9cf71e569445c0b79a7841ea411158) : 예약확인 및 고객응대 업무
7. 채널코퍼레이션: C/S 상담 업무
...
- 설문조사, 이벤트 등 일시적 목적을 위하여 수집한 경우 : 당해 설문조사, 이벤트 등의 종료 시
...
1. 파기절차: 귀하가 회원가입 등을 위해 입력하신 정보는 목적이 달성된 후 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(제6조 개인정보의 보유, 이용기간 참조) 일정 기간 저장된 후 파기되어집니다.
...
1. 스테이폴리오는 방화벽(Fire Wall)과 Nescape사의 채널보안방식인 SSL(Secure Socket Layer)방식 암호화 체계 시스템 등을 갖추어 개인정보 보호에 만전을 기하고 있습니다.
2. 세계적인 보안 인증 회사로부터 인증서를 발급 받아 스테이폴리오를 사칭하는 것을 방지하여 고객께 피해가 가지 않도록 하고 있습니다.
3. 귀하의 개인정보는 비밀번호에 의해 보호되며, 파일 및 전송 데이터를 암호화하거나 파일 잠금기능(Lock)을 사용하여 중요한 데이터는 별도의 보안기능을 통해 보호되고 있습니다.
4. 스테이폴리오는 암호알고리즘을 이용하여 네트워크 상의 개인정보를 안전하게 전송할 수 있는 보안장치(SSL 또는 SET)를 채택하고 있습니다.
...
제 9조 (링크사이트)
스테이폴리오는 귀하께 다른 회사의 웹사이트 또는 자료에 대한 링크를 제공할 수 있습니다. 이 경우 스테이폴리오 외부사이트 및 자료에 대한 아무런 통제권이 없으므로 그로부터 제공받는 서비스나 자료의 유용성에 대해 책임질 수 없으며 보증할 수 없습니다.
스테이폴리오가 포함하고 있는 링크를 클릭(Click)하여 타 사이트(Site)의 페이지로 옮겨갈 경우 해당 사이트의 개인정보처리방침은 스테이폴리오와 무관하므로 새로 방문한 사이트의 정책을 검토해 보시기 바랍니다.

제 10조 (게시물)
1. 스테이폴리오는 귀하의 게시물을 소중하게 생각하여 변조, 훼손, 삭제되지 않도록 최선을 다하여 보호합니다.그러나 다음의 경우는 그렇지 아니합니다.
...
2. 스테이폴리오는 바람직한 게시판 문화를 활성화하기 위하여 동의 없는 타인의 신상 공개 시 특정부분 이동 경로를 밝혀 오해가 없도록 하고 있습니다. 그 외의 경우 명시적 또는 개별적인 경고 후 삭제 조치할 수 있습니다.
...
2. 귀하는 개인정보를 보호받을 권리와 함께 스스로를 보호하고 타인의 정보를 침해하지 않을 의무도 가지고 있습니다. 비밀번호를 포함한 귀하의 개인정보가 유출되지 않도록 조심 하시고 게시물을 포함한 타인의 개인정보를 훼손하지 않도록 유의해 주십시오.
만약 이 같은 책임을 다하지 못하고 타인의 정보 및 존엄성을 훼손할 시에는 ‘정보통신망이용 촉진및정보보호등에관한법률’ 등에 의해 처벌받을 수 있습니다.
3. 온라인상에서(게시판, E-mail, 또는 채팅 등) 귀하가 자발적으로 제공하는 개인정보는 다른 사람들이 수집하여 사용할 수 있음을 항상 유념하시기 바랍니다. 즉, 공개적으로 접속할 수 있는 온라인상에서 개인정보를 게재하는 경우,
다른 사람들로부터 원치 않는 메시지를 답장으로 받게 될 수도 있음을 의미합니다.
...
2. 귀하의 개인정보 조회, 수정 또는 가입해지를 위해서는 스테이폴리오에 서면, 전화 또는 이메일로 연락하시면 지체 없이 조치하겠습니다.
- 스테이폴리오 대표번호 : 1670-4123
- 스테이폴리오 메일 : help@stayfolio.com
- 스테이폴리오 팩스 : 02-738-1599
3. 스테이폴리오는 귀하의 요청에 의해 해지 또는 삭제된 개인정보는 “제 6조 개인정보의 보유, 이용기간’에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.

제 13조 (개인정보 자동 수집 장치의 설치, 운영 및 그 거부에 관한 사항)
1. 쿠키(cookie)란?
스테이폴리오는 귀하에 대한 정보를 저장하고 수시로 찾아내는 쿠키(cookie)를 사용합니다. 쿠키는 웹사이트가 귀하의 컴퓨터 브라우저(넷스케이프, 인터넷익스플로러 등)로 전송하는 소량의 정보입니다.
귀하께서 웹사이트에 접속을 하면 스테이폴리오의 서버는 귀하의 브라우저에 추가정보를 임시로 저장하여 접속에 따른 성명 등의 추가 입력 없이 스테이폴리오의 서비스를 제공할 수 있습니다.
...
2. 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아 래와 같이 관련 부서를 지정하고 있습니다.
...
4. 전화상담은 월~금요일 오전 10:00 ~ 오후 06:30에만 가능합니다. (주말, 공휴일 휴무)
...
제 15조 (개인정보보호책임자 및 담당부서)
스테이폴리오는 귀하가 좋은 정보를 안전하게 이용할 수 있도록 최선을 다하고 있습니다. 개인정보를 보호하는데 있어 귀하께 고지한 사항들에 반하는 사고가 발생할 시에 개인정보보호책임자가 모든 책임을 집니다.
...
제 16조 (고지의 의무)
개인정보처리방침은 2015년 04월 20일부터 적용됩니다. 내용의 추가, 삭제 및 수정이 있을 시에는 개정 최소 7일전부터 홈페이지의 공지사항을 통하여 고지할 것입니다.
또한 개인정보처리방침에 버전번호 및 개정일자 등을 부여하여 개정여부를 쉽게 알 수 있도록 하고 있습니다.
- 개인정보처리방침 버전번호 : Ver.2.01
- 개인정보처리방침 변경공고일자 : 2021년 11월 16일
- 개인정보처리 시행일자 : 2021년 11월 16일
						</pre>
					</div>
					<br>
...
만 14세 미만 아동이 법정대리인 동의 없이 회원가입을 할 경우 회원탈퇴 또는 서비스 이용에 제한이 있을 수 있습니다.
					...
					<div id="detail" style="display:none;overflow:scroll;text-align:left;width:400px;height:200px;">
						<pre>
평생회원제에 동의할 경우 1년 이상 서비스를 이용하지 않아도 휴면 처리되지 않습니다.
						</pre>
					</div>
					<br>
...
또한 서비스의 중요 안내사항 및 예약에 대한 정보는 마케팅 정보 수신 동의 여부와 관계없이 발송됩니다.
