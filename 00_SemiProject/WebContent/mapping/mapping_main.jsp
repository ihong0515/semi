...
<script type="text/javascript">
		...
		$.ajax({
			...
			success: function(data){
				...
				$(data).find("hotel").each(function(){
					table += "<div>";
					table += "<p><img onclick='location.href='hotel_get_Content.do?hotel_no="+$(this).find("hotel_no").text()+"'' src='/00_SemiProject/image/hotel/" + $(this).find("hotel_photo_folder").text() + "/main.jpg' style='width:100px; height:100px;'></p>";
					
					table += "<p>"+$(this).find("hotel_name").text();
	...
	function changeimg(img) {
		let imgPath = '<%=request.getContextPath() %>/'+img;
			...
			<div id="content">
				<div id="mapping" align="center">
					...
					<map name="mapping_area">
						...
						onmouseover="changeimg('image/map/seoul.jpg')" onmouseout="changeimg('image/map/koreaMap.jpg')" onclick="mapping_searchHotel(this)" target="" />
						...
						onmouseover="changeimg('image/map/kyungki.jpg')" onmouseout="changeimg('image/map/koreaMap.jpg')" onclick="serchHotelList(this)" target="" />
						...
						onmouseover="changeimg('image/map/kangwon.jpg')" onmouseout="changeimg('image/map/koreaMap.jpg')" onclick="mapping_searchHotel(this)" target="" />
						...
						onmouseover="changeimg('image/map/chungbuk.jpg')" onmouseout="changeimg('image/map/koreaMap.jpg')" onclick="mapping_searchHotel(this)" target="" />
						...
						onmouseover="changeimg('image/map/chungnam.jpg')" onmouseout="changeimg('image/map/koreaMap.jpg')" onclick="mapping_searchHotel(this)" target="" />
						...
						onmouseover="changeimg('image/map/kyungbuk.jpg')" onmouseout="changeimg('image/map/koreaMap.jpg')" onclick="mapping_searchHotel(this)" target="" />
						...
						onmouseover="changeimg('image/map/kyungnam.jpg')" onmouseout="changeimg('image/map/koreaMap.jpg')" onclick="mapping_searchHotel(this)" target="" />
						...
						onmouseover="changeimg('image/map/junbuk.jpg')" onmouseout="changeimg('image/map/koreaMap.jpg')" onclick="mapping_searchHotel(this)" target="" />
						...
						onmouseover="changeimg('image/map/junnam.jpg')" onmouseout="changeimg('image/map/koreaMap.jpg')" onclick="mapping_searchHotel(this)" target="" />
						<area shape="poly" alt="제주" title="" coords="91,552,127,516,203,514,219,526,224,544,203,569,154,577,114,571,110,582,97,566" 
						onmouseover="changeimg('image/map/jeju.jpg')" onmouseout="changeimg('image/map/koreaMap.jpg')" onclick="mapping_searchHotel(this)" target="" />
					</map>
				</div>
				<div id="mapping_hotel_list">
				</div>
			</div>
